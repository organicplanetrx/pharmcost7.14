...
// REMOVED: Legacy HTML interface function to eliminate route conflicts
    <style>
...
// End of REMOVED legacy HTML interface
...
export async function registerRoutes(app: Express): Promise<Server> {
  // Legacy HTML interface REMOVED - React app serves from root
