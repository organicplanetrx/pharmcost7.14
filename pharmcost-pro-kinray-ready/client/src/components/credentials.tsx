  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Kinray Portal Credentials</h1>
          <p className="text-slate-600 mt-1">Manage your Kinray (Cardinal Health) login credentials</p>
        </div>
      </div>
